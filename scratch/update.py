...
route_path = 'src/app/api/extract-card/route.ts'
...
old_logic_start = "    // 3.5. OpenCV Perspective Transform"
old_logic_end = "    // 3.5 Duplicate Detection"

start_idx = content.find(old_logic_start)
end_idx = content.find(old_logic_end)

new_logic = """    let finalImagePath = imagePath;
