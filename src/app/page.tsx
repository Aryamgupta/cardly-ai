...
import { ArrowRight, PlayCircle, Menu, Home, User, Plus, Search, RefreshCw, Zap, Rocket, ChevronRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-tertiary text-foreground dark flex flex-col pb-20 md:pb-0">
      ...
      <header className="flex items-center justify-between p-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-white tracking-wide">Cardly AI</span>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center px-6 pt-8 pb-16">
        {/* Hero Section */}
        <div className="w-full max-w-4xl flex flex-col items-start text-left md:items-center md:text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mt-4 leading-relaxed">
            Scan any business card. AI extracts the context, not just the text. Build your smart CRM in seconds.
          </p>
        ...
        <div className="w-full max-w-sm mt-16 relative">
          <div className="text-center text-[10px] font-bold text-white/40 tracking-widest uppercase mb-4">
          ...
          <div className="relative w-full aspect-[9/19] rounded-[2.5rem] border-8 border-white/10 bg-black overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 bg-[#0B1020] flex flex-col p-4 pt-10">
               <div className="flex justify-between items-center text-white mb-8">
                  <div className="w-6 h-6 rounded bg-white/20 flex items-center justify-center text-xs">X</div>
               ...
               <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                  <p className="text-[10px] text-white/80 leading-tight">
                    <strong className="text-secondary">AI Insight:</strong> met at TechSummit. Interested in CRM integration and series B funding discussions. High priority follow-up.
                  </p>
               </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md mt-24 space-y-4">
          <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Intelligent Extraction</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Our neural network doesn't just read words—it understands roles, companies, and relationship context instantly.
            </p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Global Search</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Find anyone by name, skill, or that specific conversation you had at a conference three months ago.
            </p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Universal Sync</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Seamlessly push new contacts to Salesforce, HubSpot, or your native phone contacts with one tap.
            </p>
          </div>

          <div className="bg-gradient-to-br from-primary/20 to-secondary/10 border border-primary/20 p-8 rounded-3xl mt-8 relative overflow-hidden">
            <h3 className="text-2xl font-bold text-white mb-3 relative z-10">Master Your Rolodex</h3>
            <p className="text-white/80 text-sm leading-relaxed relative z-10">
              The average professional loses 30% of their contacts within one month. Cardly ensures you never lose a connection again.
            </p>
          </div>

          <div className="grid grid-cols-2 gap-4 pt-4">
            <div className="bg-white/5 border border-white/10 p-5 rounded-2xl flex flex-col items-center justify-center text-center">
              <Rocket className="w-6 h-6 text-secondary mb-2" />
              <div className="text-2xl font-bold text-white">99.8%</div>
              <div className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-1">Accuracy</div>
            </div>
            <div className="bg-white/5 border border-white/10 p-5 rounded-2xl flex flex-col items-center justify-center text-center">
              <div className="text-3xl font-bold text-primary mb-1">2M+</div>
              <div className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider">Cards Scanned</div>
            </div>
          </div>
          
          <div className="bg-white/5 border border-white/10 p-5 rounded-2xl flex flex-col items-center justify-center text-center mt-4">
             <div className="text-2xl font-bold text-primary mb-1">AI-Ready</div>
             <div className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider">LLM Analysis</div>
          </div>
        </div>
      ...
      <footer className="w-full flex flex-col items-center justify-center py-12 px-6 border-t border-white/10 pb-32">
        ...
        <p className="text-xs text-muted-foreground mb-6">© 2024 Cardly AI Precision Networking.</p>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0B1020]/90 backdrop-blur-md border-t border-white/10 pb-safe md:hidden z-50">
        <div className="flex items-center justify-around p-3 pb-6 relative">
          ...
          <div className="absolute left-1/2 -top-6 -translate-x-1/2">
            <Link href="/scan" className="w-14 h-14 bg-primary text-white rounded-full flex items-center justify-center shadow-lg shadow-primary/30 hover:scale-105 transition-transform border-4 border-[#0B1020]">
              <Plus className="w-6 h-6" />
            </Link>
          </div>

          <Link href="/login" className="flex flex-col items-center gap-1 text-muted-foreground hover:text-white transition-colors">
